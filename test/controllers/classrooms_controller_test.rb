...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { admin_id: @classroom.admin_id, name: @classroom.name, quizlet_id: @classroom.quizlet_id }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { admin_id: @classroom.admin_id, name: @classroom.name, quizlet_id: @classroom.quizlet_id }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
